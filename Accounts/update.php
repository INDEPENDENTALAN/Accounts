...
$sql = "UPDATE dbname SET name = '$name_update', email = '$email_update', pass = '$pass_update' WHERE id = '$id'";
                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="edit-form" action="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="re_pass" id="re_pass" value="<?php echo $pass; ?>" placeholder="Repeat your password"/>
                            </div>
